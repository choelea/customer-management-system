...
/**
 * @ClassName : CustomerManagementApplication
 * @Description :
 * @Author Franky
...
//        SpringApplication.run(CustomerManagementApplication.class, args);
        ...
        final ConfigurableApplicationContext application = SpringApplication.run(CustomerManagementApplication.class, args);
