package com.management.restcontroller;
...
public class CustomerRestController {
    ...
    @Autowired
    public CustomerRestController(CustomerService customerService, DatabaseService databaseService) {
    ...
    public String listCustomers(Model model) {
        ...
        model.addAttribute("databaseNames", databaseService.getAllDatabaseNames());
        return "customers";
    }
